...
public class InvoiceHeadServiceImpl extends BaseApiService implements InvoiceHeadService{
	...
	public Integer save(@RequestBody InvoiceHead invoiceHead,String state){
		 ...
		 * 设置销方信息,
		 */
		invoiceHead.setOrgName("杭州中德传动设备有限公司");
		invoiceHead.setOrgTaxcode("913301097338279451");
		invoiceHead.setOrgMachine("00");
		invoiceHead.setOrgAddress("萧山经济技术开发区鸿达路66号");
		invoiceHead.setOrgTelephone("0571-22892901");
		invoiceHead.setOrgBankname("工行杭州江南支行");
		invoiceHead.setOrgBankaccount("1202092019900027211");
		invoiceHead.setUserId("1");
		invoiceHead.setUserName("史佳萍");
		invoiceHead.setCheckName("叶缨");
		invoiceHead.setPayeeName("胡小蓓");
//		invoiceHead.setOrgName("宁波中金融资租赁有限公司");
//		invoiceHead.setOrgTaxcode("91330200MA2AE4HJ04");
//		invoiceHead.setOrgMachine("00");
//		invoiceHead.setOrgAddress("宁波市北仑区宝山路128号黄金海岸D2幢18层");
//		invoiceHead.setOrgTelephone("0574-86965692");
//		invoiceHead.setOrgBankname("中国工商银行宁波市分行营业部");
//		invoiceHead.setOrgBankaccount("3901020009000152659");
//		invoiceHead.setUserId("lihui");
//		invoiceHead.setUserName("沈丹盛");
//		invoiceHead.setCheckName("陈燕");
//		invoiceHead.setPayeeName("柯颐瑶");
...
//			manager.delete("invoice_merges_line.del", invoiceHead);
			...
			if(originalLines!=null&&originalLines.size()>0) {
				for(InvoiceOriginalLine type:originalLines) {
					...
					type.setDocLine(type.getDocOrigline());
